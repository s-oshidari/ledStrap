...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        esp_ble_gap_set_device_name(_local_name.c_str());
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle,
                               ...
                               ESP_GATT_PERM_READ_WRITE,
                               ESP_GATT_CHAR_PROP_BIT_READ_WRITE_NOTIFY,
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        esp_ble_gatts_add_char_descr(gl_profile_tab[PROFILE_A_APP_ID].service_handle, &gl_profile_tab[PROFILE_A_APP_ID].descr_uuid,
                                     ESP_GATT_PERM_READ_WRITE, NULL, NULL);
        break;
    }
...
void GattServer::setWriteCallback(void (*handleWriteCallback)(esp_ble_gatts_cb_param_t*))
{
  _handleWriteCallback = handleWriteCallback;
}
...
bool GattServer::begin(String localName)
{
  if(localName.length()){
